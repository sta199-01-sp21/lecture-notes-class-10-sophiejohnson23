...
Close but not perfect, because you only drew the marble 10,000 times, not an
infinite number of times, which would be needed to find the "true" probability.
...
Low probability, around 0.1 for blue, 0.25 for red, and 0.01 for white.
...
I think the first option has the higher probability.
